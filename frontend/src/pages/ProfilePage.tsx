...
const ProfilePage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchUserPosts = async () => {
      try {
        setLoading(true);
        // Assuming there's an endpoint or filter for user's posts
        // For now, fetching all and filtering (not ideal for prod but works for demo)
          ...
          >
                            ...
                            <div className="flex-grow flex flex-col justify-between">
                              <div>
                                <div className="flex justify-between items-start">
                                  ...
                                  <Chip size="sm" variant="flat" color="primary">{post.category.name}</Chip>
                                </div>
            ...
            <Tab key="drafts" title="Drafts">
              <div className="py-12 text-center text-slate-500">
                <p>Drafts functionality coming soon!</p>
              </div>
            </Tab>
